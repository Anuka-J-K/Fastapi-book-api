...
A simple and efficient REST API built with **FastAPI** to manage a collection of books. This project demonstrates core FastAPI fundamentals including Routing, Pydantic validation, and Dependency Injection.
